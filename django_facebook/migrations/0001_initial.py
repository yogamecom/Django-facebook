...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('django_facebook_facebook_invite', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('user_invited', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('message', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('wallpost_id', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('error', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('error_message', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('last_attempt', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('reminder_wallpost_id', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('reminder_error', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('reminder_error_message', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('reminder_last_attempt', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
        ))
        db.send_create_signal(u'django_facebook', ['FacebookInvite'])

        # Adding unique constraint on 'FacebookInvite', fields ['user', 'user_invited']
        db.create_unique('django_facebook_facebook_invite', ['user_id', 'user_invited'])
